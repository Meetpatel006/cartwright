...
import {
  ...
  HoverCardContent,
  HoverCardTrigger,
} from "@cartwright/ui/components/hover-card";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from "@cartwright/ui/components/select";
import { Spinner } from "@cartwright/ui/components/spinner";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
...
export const PromptInputSubmit = ({
  ...
  let Icon: ReactNode = <ArrowUpIcon className="size-4" />;
