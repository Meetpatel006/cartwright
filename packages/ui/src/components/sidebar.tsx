...
import { useIsMobile } from "@cartwright/ui/hooks/use-mobile"
...
import { Separator } from "@cartwright/ui/components/separator"
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@cartwright/ui/components/sheet"
import { Skeleton } from "@cartwright/ui/components/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-0 group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
